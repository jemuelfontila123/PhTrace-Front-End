...
const RegisterForm = ({ userRegister, establishmentRegister, setSuccessful}) => {
    ...
    return(
        <div className="container section-grid register-form">
            ...
            <div className='main-form'>
                ...
                <form className='frm frm-register' onSubmit={handleSubmit(user === 'User' ? handleUser: handleEstablishment)}>
                    <div className='frm-title'>
                        <h2>Sign Up</h2>
                        <h6>Enter your details to create your account</h6>
                    </div>
                    <UserSelect description={'Register as...'} user={user} setUser={setUser}/>
                    { user ==='User' ? 
                    <>
                    <div>
                    ...
                    <div>
                        ...
                        <input name='contactPerson' ref={register({required: true})} placeholder="Contact Person" />
                        {errors.contactPerson && <p>Contact Person is required</p>}
                     </div>
                    <div>
                        <label>Establishment Name</label>
                        <input name='establishmentName' ref={register({required: true})}  placeholder="Establishment name"/>
                        {errors.establishmentName && <p>Establishment name is required</p>}
                    </div>
                    </>
                    }
                    <div>
                        <label>Email</label>
                        <input name='email' type='email'ref={register({required: true})} placeholder="Email" onChange={() => setEmailVisible(false)}/>
                        <p style={showEmail} className='error'>{emailError} already exists </p>
                    ...
                    <div>
                        ...
                        {errors.password && errors.password.type === 'minLength' && 
                            ...
                            { errors.password&& errors.password.type === 'pattern' &&
                                <p>Your password must contain at least one number and one uppercase</p>
                            }
                            <small>Your password should be at least 8 characters</small>
                            <small>Your password must contain at least one  number and one uppercase</small>
                        </div>
                    </div> 
                    <div>
