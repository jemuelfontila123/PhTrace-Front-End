        ...
        <div className='container section-grid login-form'>
            ...
            <div className='main-form'>
                ...
                <form className='frm frm-login' onSubmit={handleSubmit(handleLogin)}>
                    ...
                    <div>    
                        <label> Email</label>
                        <input name='email' placeholder ='Email' ref={register({required: true})} type='email' onChange={() => setError(false)}/>
                        {errors.email && <p>Email is required</p>}
                    </div>
                    <div>    
                        <label> Password</label>
                        <input type='password' name='password' placeholder ='&bull;&bull;&bull;&bull;&bull;&bull;&bull;&bull;' ref={register({required: true})} onChange={() => setError(false)}/>
