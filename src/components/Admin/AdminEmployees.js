...
const AdminEmployees = ({employeeSuccess, handleSmsMessage}) => {
    const employeesData = ['#','Name','Email','Contact Number','Role','Actions']
    ...
    return(
        ...
        <div>
           ...
           <Table 
                ...
                />
           <DialogForm open={open} setOpen={setOpen} title={'Adding new employee'} content={'Fill in the the following information to create employee who can scan'}>
