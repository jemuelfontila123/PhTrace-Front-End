            ...
            <div className='settings-body'>
                <form className='frm frm-wrapper' onSubmit={handleSubmit(handleUpdate)}>
                    <div>
                        ...
                        <input name='firstName'  ref={register} placeholder={user.firstName}/>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input name='password' type='password' ref={register}placeholder ='&bull;&bull;&bull;&bull;&bull;&bull;&bull;&bull;'/>
                    </div>
                    ...
                    <div className='settings-choices'>
                        ...
                        <div >
                            <Button variant="outlined" color="primary" onClick={() => setPage(1)} className='but'>
                                <HomeIcon/>
                                <span>Home</span>
                            </Button>
                        </div>    
                        <div>
                            <Button variant="outlined" color="primary" className='but' onClick={() => userContext.logOut()}>
                                <ExitToAppIcon/>
                                <span>Log Out</span>
                            </Button>
                        </div>
